          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                For speaking engagements, media inquiries, or course information, please feel free to reach out.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  <Mail className="h-5 w-5 mr-3 text-accent" />
                  <a href="mailto:contact@dheerendrasingh.com" className="hover:text-primary transition-colors">contact@dheerendrasingh.com</a>
                </div>
                <div className="flex items-center">
